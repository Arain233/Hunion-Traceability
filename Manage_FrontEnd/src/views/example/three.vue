<template>
  <div class="createPost-container">
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <el-steps :active="3" align-center class="showProcess">
        <el-step title="原料商" description="已录入"></el-step>
        <el-step title="生产方" description="已录入"></el-step>
        <el-step title="经销商" icon="el-icon-edit" description="正在录入信息..."></el-step>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        EnterpCode: [{validator: validateRequire, name: "经销商代码"}],
        Name: [{validator: validateRequire, name: "经销商名称"}],
        Address: [{validator: validateRequire, name: "经销商地址"}]
      },
      tempRoute: {}
    }
  },
    ...
    submitForm() {
      ...
      this.$refs.postForm.validate(valid => {
        if (valid) {
          ...
          axios({
            method: 'post',
            url: 'http://120.76.197.109:8282/api/dealer/save',
            data: {
