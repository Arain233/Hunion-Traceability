<template>
  <div class="createPost-container">
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <el-steps :active="2" align-center class="showProcess">
        <el-step title="原料商" description="已录入"></el-step>
        <el-step title="生产方" icon="el-icon-edit" description="正在录入信息..."></el-step>
  ...
  data() {
    ...
    return {
      ...
      rules: {
        ...
        EnterpCode: [{validator: validateRequire, name: "生产代码"}],
        MFD: [{validator: validateRequire, name: "商品生产日期"}],
        Name: [{validator: validateRequire, name: "商品名称"}],
        OriginPlace: [{validator: validateRequire, name: "商品产地"}]
      },
      tempRoute: {}
    }
  },
    ...
    submitForm() {
      ...
      this.$refs.postForm.validate(valid => {
        if (valid) {
          ...
          axios({
            method: 'post',
            url: 'http://120.76.197.109:8282/api/commodity/save',
            data: {
