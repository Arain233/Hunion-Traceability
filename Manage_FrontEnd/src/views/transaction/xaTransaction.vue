      ...
      <el-row v-if="stepActive === 1" style="margin-top: 10px; ">
        <el-card style="height: 60vh">
            ...
            <el-row>
              <el-col :span="11" style="text-align: left">
                ...
                <el-tooltip effect="light" content="如何执行事务？" placement="top">
                  <el-button type="text" size="mini" style="margin-left: 10px;padding: 0px" icon="el-icon-question"
                             @click="() => {$tours['execXAGuide'].start()}"/>
                </el-tooltip>
              </el-col>
          ...
          <el-col id="xaList" :span="12" :offset="1">
            ...
            <el-row>
              <el-table stripe fit style="width: 100%;" height="calc(60vh - 160px)" :data="transactionStep"
            ...
            <el-col>
              ...
              >
                ...
                <el-table-column type="expand" width="80px" label="事务步骤">
                  <template slot-scope="props">
                    <el-table stripe fit style="width: 100%;" :data="props.row.xaTransactionSteps"
                              tooltip-effect="light">
...
import {getResourceListByChain} from '@/api/resource'
import {call, getXATransaction, sendTransaction} from '@/api/transaction'
import {parseTime, limitString} from '@/utils/oftenUse'
